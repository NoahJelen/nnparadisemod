...
public class DUChunkProvider implements IChunkGenerator {
	...
	private final WorldGenerator lrGen = new WorldGenMinable(
			LiquidRedstone.BlockLiquidRedstone.instance.getDefaultState(), 3, BlockMatcher.forBlock(Blocks.STONE));
	...
	private final WorldGenMinable sapling = new WorldGenMinable(Blocks.SAPLING.getDefaultState(), 3,
	...
	double[] noiseData4;
	double[] dr;
	public DUChunkProvider(World worldIn, boolean p_i45637_2_, long seed) {
		world = worldIn;
		...
		genDUCaves = net.minecraftforge.event.terraingen.TerrainGen.getModdedMapGen(genDUCaves,
		...
		if (net.minecraftforge.event.terraingen.TerrainGen.generateOre(world, rand, coalGen, blockpos,
			...
			for (int l1 = 0; l1 < 32; ++l1) {
				...
				goldGen.generate(world, rand,
						blockpos.add(rand.nextInt(16), rand.nextInt(216) + 20, rand.nextInt(16)));
				silverGen.generate(world, rand,
						blockpos.add(rand.nextInt(16), rand.nextInt(216) + 20, rand.nextInt(16)));
				saltGen.generate(world, rand,
								blockpos.add(rand.nextInt(16), rand.nextInt(216) + 20, rand.nextInt(16)));
				
				//lights
				lightsGen.generate(world, rand,
						blockpos.add(rand.nextInt(16), rand.nextInt(216) + 20, rand.nextInt(16)));
				lightsGen2.generate(world, rand,
						blockpos.add(rand.nextInt(16), rand.nextInt(216) + 20, rand.nextInt(16)));
