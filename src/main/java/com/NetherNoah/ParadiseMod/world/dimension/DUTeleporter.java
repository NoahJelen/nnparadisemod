...
public class DUTeleporter extends Teleporter{
	
	private final WorldServer worldServerInstance;
    private final Random random;
    private final Long2ObjectMap<Teleporter.PortalPosition> destinationCoordinateCache = new Long2ObjectOpenHashMap(4096);
	public DUTeleporter(WorldServer worldIn) {
		super(worldIn);
	...
	public boolean makePortal(Entity entityIn)
    {
        ...
        IBlockState iblockstate = ModBlocks.DUPortal.getDefaultState().withProperty(BlockPortal.AXIS, l6 == 0 ? EnumFacing.Axis.Z : EnumFacing.Axis.X);
