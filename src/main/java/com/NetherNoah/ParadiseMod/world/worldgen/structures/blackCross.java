...
public class blackCross extends WorldGenerator implements IWorldGenerator{
	...
	public void generate(Random rand, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator,
		...
		generate(world, rand, pos,isVoid);
	}
	...
	public static int getGroundFromAbove(World world, int x, int z)
	{
		...
		while(!foundGround && y-- >= 50)
		{
			Block blockAt = world.getBlockState(new BlockPos(x,y,z)).getBlock();
			foundGround = blockAt == Blocks.SAND||blockAt == Blocks.GRASS||blockAt == Blocks.DIRT||blockAt == Blocks.STONE||blockAt == Blocks.WATER||blockAt==Misc.VoidStone;
		}
		return y;
	}

	public boolean generate(World world, Random rand, BlockPos position, Boolean isVoid) {
		...
		if(rand.nextInt(777) == 0){
			...
			//(0,13)
			blockToReplace = world.getBlockState(new BlockPos(x,y-1,z+12)).getBlock();
			while ((blockToReplace==Blocks.WATER
					  ||blockToReplace==Blocks.COBBLESTONE
					  ||blockToReplace==Blocks.FLOWING_WATER
					  ||blockToReplace instanceof BlockAir
					  ...
					  ||blockToReplace instanceof BlockLeaves)
					  &&y>0) {
				world.setBlockState(new BlockPos(x,y,z+12), Utils.getRandomBrick());
				blockToReplace = world.getBlockState(new BlockPos(x,y-1,z+12)).getBlock();
				y--;
			}
			y=position.getY();
			...
			//(7,13)
			blockToReplace = world.getBlockState(new BlockPos(x+6,y-1,z+12)).getBlock();
			while ((blockToReplace==Blocks.WATER
					  ||blockToReplace==Blocks.COBBLESTONE
					  ||blockToReplace==Blocks.FLOWING_WATER
					  ||blockToReplace instanceof BlockAir
					  ...
					  ||blockToReplace instanceof BlockLeaves)
					  &&y>0) {
				world.setBlockState(new BlockPos(x+6,y,z+12), Utils.getRandomBrick());
				blockToReplace = world.getBlockState(new BlockPos(x+6,y-1,z+12)).getBlock();
				y--;
			}
			return true;
