...
public class LandMineGen extends WorldGenerator {
	@Override
	public boolean generate(World world, Random rand, BlockPos position) {
		...
		Template template = templatemanager.getTemplate(minecraftserver, new ResourceLocation(Reference.MOD_ID+":landmines/landmine"));
		if(ModConfig.worldgen.structures.Landmines==false)
			return false;
		if(LandMineGen.canSpawnHere(template, worldserver, position)) {
