...
public class EmeraldPlateCode extends BlockBasePressurePlate
{
    public static final PropertyBool POWERED = PropertyBool.create("powered");
    private final EmeraldPlateCode.Sensitivity sensitivity;
    protected EmeraldPlateCode(Material materialIn, EmeraldPlateCode.Sensitivity sensitivityIn)
    {
        super(materialIn);
