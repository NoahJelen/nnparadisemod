...
public class DiamondPlateCode extends BlockBasePressurePlate
{
    public static final PropertyBool POWERED = PropertyBool.create("powered");
    private final DiamondPlateCode.Sensitivity sensitivity;
    protected DiamondPlateCode(Material materialIn, DiamondPlateCode.Sensitivity sensitivityIn)
    {
        super(materialIn);
