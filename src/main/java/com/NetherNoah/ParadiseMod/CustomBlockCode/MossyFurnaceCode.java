...
public class MossyFurnaceCode extends BlockContainer
{
    public static final PropertyDirection FACING = BlockHorizontal.FACING;
    private final boolean isBurning;
    private static boolean keepInventory;
    protected MossyFurnaceCode(boolean isBurning)
    {
        super(Material.ROCK);
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            {
                playerIn.displayGUIChest((TEMossyFurnace)tileentity);
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state)
    {
        if (!keepInventory)
        {
            ...
            if (tileentity instanceof TEMossyFurnace)
            {
                InventoryHelper.dropInventoryItems(worldIn, pos, (TEMossyFurnace)tileentity);
